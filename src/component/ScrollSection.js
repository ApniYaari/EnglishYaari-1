            ...
            return (
                <div style={{ background: '#E0E9FF' }} className="flex bg-white w-[280px] justify-center items-center gap-2 py-1.5 rounded-full ">
                    ...
                    <svg width="19" height="19" viewBox="0 0 19 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g clip-path="url(#clip0_570_1605)">
                            <path d="M16.6354 4.44141L9.8905 11.1863L7.08014 8.37592L2.02148 13.4346" stroke="#262527" stroke-width="1.12415" stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M16.6353 8.93799V4.44141H12.1387" stroke="#262527" stroke-width="1.12415" stroke-linecap="round" stroke-linejoin="round" />
                        </g>
                        <defs>
                            <clipPath id="clip0_570_1605">
                                <rect width="17.9863" height="17.9863" fill="white" transform="translate(0.334961 0.507812)" />
                            </clipPath>
                        </defs>
                    </svg>
