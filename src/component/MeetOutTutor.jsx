...
// function MeetOutTutor() {
//   return (
//     <div className="relative p-4 mt-4 lg:mt-10  container">
//       <p className="text-3xl font-semibold text-black text-center pt-10 ">
//         Meet Our Tutors
//       </p>
//       <div className=" bg-white mx-auto p-4 rounded-3xl mt-5 flex w-full justify-around lg:justify-between flex-wrap z-50 border border-[#DBDBDB]">
//         {Array(4)
//           .fill()
//           .map((_, ind) => (
//             <MeetTutorCard key={ind} />
//           ))}
//       </div>
...
export const MeetOutTutor = (props) => {
  ...
  return (
    <div className="w-full    ml-5 lg:ml-auto lg:w-[90vw] mx-auto ">
       ...
       <p className="text36 font-semibold text-black text-center pb-10  ">
         Meet Our Tutors
      </p>
      {
        ...
        <div className=" mt-3 overflow-hidden rounded-xl">
          <div
            id="slider"
            className="flex  bg-white p-4 w-full overflow-scroll scroll rounded-xl  whitespace-nowrap scroll-smooth border border-[#DBDBDB]"
          >
