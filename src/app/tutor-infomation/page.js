...
import { expertisetag, primaryColor, slotTimingArray, vedioId } from "@/utils/utils";
                ...
                <div className="flex ">
                    {["Availability", "Reviews",].map((ele, ind) => {
                        return (
                            ...
                            key={ind} className="px-4 font-semibold">
                                {ele}
                            </button>
                        );
                    })}
    ...
    return (
        <div className="bg-white w-full mt-6 p-4 relative shadow-2xl rounded-lg">
            ...
            <div className="h-full absolute w-full top-0 left-0  flex justify-center items-center backdrop-blur-sm bg-white/30">
                <button className={twMerge(" text18 text-white flex items-center gap-3 px-6 rounded-full py-2", `bg-[${primaryColor[500]}]`)}>
