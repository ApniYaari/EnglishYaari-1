...
const CourseNeed = ({ width, img, tittle, desc, bg }) => {
    return (
      <div
        className={`${bg}  border break-words border-stroke_Color min-w-[18rem] 3xxl:min-w-[22rem] mr-6 rounded-3xl  flex px-4 py-6  flex-col gap-3 margin24 `}
      >
        <Image
          ...
          src={img}
        />
        <p className="text h5 font-bold 2xll:leading-10 ">{tittle}</p>
