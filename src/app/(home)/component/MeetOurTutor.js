    ...
    <div className="w-full     lg:ml-auto lg:w-[90vw] mx-auto ">
      ...
      </p>
      {
        ...
        <div className=" margin24 overflow-hidden rounded-xl">
          <div className="border border-[#DBDBDB] py-8 lg:py-4 bg-white overflow-hidden lg:rounded-2xl">
          <div
            id="slider"
            className="flex  w-full overflow-scroll scroll   whitespace-nowrap scroll-smooth "
          >
            <div className=" bg-white mx-auto  lg:gap-x-3  rounded-3xl  flex w-full justify-around lg:justify-between  ">
